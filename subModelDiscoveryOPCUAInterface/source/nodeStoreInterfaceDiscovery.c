...
#ifndef OV_COMPILE_LIBRARY_subModelDiscoveryOPCUAInterface
#define OV_COMPILE_LIBRARY_subModelDiscoveryOPCUAInterface
#endif

#include "subModelDiscoveryOPCUAInterface.h"
#include "ov_macros.h"
#include "ksbase.h"
#include "opcua.h"
...
UA_NodestoreInterface* subModelDiscoveryOPCUAInterface_interface_ovNodeStoreInterfaceSubModelDiscoveryNew(void) {
...
void subModelDiscoveryOPCUAInterface_interface_ovNodeStoreInterfaceSubModelDiscoveryDelete(UA_NodestoreInterface * nsi){
	if (nsi->handle)
		UA_free(nsi->handle);
}
