...
*   FILE
*   ----
*   DSUnregistrationServiceTypeSQLC.c
*
*   History
*   -------
...
OV_DLLFNCEXPORT OV_RESULT DSServices_DSUnregistrationServiceTypeSQLC_executeService(OV_INSTPTR_openAASDiscoveryServer_DSService pinst, const json_data JsonInput, OV_STRING *JsonOutput, OV_STRING *errorMessage) {
    /*    
    *   local variables
    */
	// Parsing Body
...
OV_DLLFNCEXPORT OV_ACCESS DSServices_DSUnregistrationServiceTypeSQLC_getaccess(
