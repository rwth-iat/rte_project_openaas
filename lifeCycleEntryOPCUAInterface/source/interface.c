...
OV_INSTPTR_lifeCycleEntryOPCUAInterface_interface pinterface = NULL;
...
OV_DLLFNCEXPORT OV_RESULT lifeCycleEntryOPCUAInterface_interface_constructor(
    ...
    */
    ...
    /* do what */
    Ov_ForEachChild(ov_instantiation, pclass_lifeCycleEntryOPCUAInterface_interface, pOtherObject){
...
OV_DLLFNCEXPORT void lifeCycleEntryOPCUAInterface_interface_startup(
    ...
    */
    ...
    /* do what */
    UA_String tmpNamespaceName = UA_String_fromChars("http://acplt.org/lifeCycleEntry/");
	UA_Namespace_init(&pinst->v_modelnamespace, &tmpNamespaceName);
	UA_String_deleteMembers(&tmpNamespaceName);
	pinst->v_modelnamespace.dataTypes = UA_LIFECYCLEENTRY;
	pinst->v_modelnamespace.dataTypesSize = UA_LIFECYCLEENTRY_COUNT;

	tmpNamespaceName = UA_String_fromChars("http://acplt.org/lifeCycleEntry/Ov");
	UA_Namespace_init(&pinst->v_interfacenamespace, &tmpNamespaceName);
	UA_String_deleteMembers(&tmpNamespaceName);
	pinst->v_interfacenamespace.nodestore = lifeCycleEntryOPCUAInterface_interface_ovNodeStoreInterfaceLifeCycleEntryNew();
...
OV_DLLFNCEXPORT OV_ACCESS lifeCycleEntryOPCUAInterface_interface_getaccess(
	OV_INSTPTR_ov_object	pobj,
